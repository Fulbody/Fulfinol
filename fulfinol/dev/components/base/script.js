...
components.regula = {
	...
	init: function ( nodes ) {
		...
		regula.custom({
			name: 'PhoneNumber',
			defaultMessage: 'Le numéro de télephone est incorrect.',
			validator: function() {
		...
		let regularConstraintsMessages = [
			{
				...
				newMessage: "Le texte est requis"
			},
			{
				type: regula.Constraint.Email,
				newMessage: "L'adresse mail que vous avez tenté d'écrire n'est pas valide"
			},
			{
				type: regula.Constraint.Numeric,
				newMessage: "Un numéro de téléphone est requis"
			},
			{
				type: regula.Constraint.Selected,
				newMessage: "s'il vous plaît veuillez choisir une option"
			}
		];
